...
class FileStorage():
    ...
    def all(self):
        """
        public instance method returns the
    ...
    def new(self, obj):
        """
        public instance method sets in __objects
    ...
    def save(self):
        """
        public instance method serializes __objects
    ...
    def reload(self):
        """
        public instance method deserializes a JSON
        file to __objects.
        """
        try:
