...
class TestState_instantiation(unittest.TestCase):
    """
    Unittests testing instantiation of State class.
    """
...
class TestState_save(unittest.TestCase):
    """
    Unittests testing save method of State class.
    """
...
class TestState_to_dict(unittest.TestCase):
    """
    Unittests testing to_dict method of State class.
    """
