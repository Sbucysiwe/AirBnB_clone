...
class TestAmenity_instantiation(unittest.TestCase):
    """
    Unittests testing instantiation of Amenity class.
    """
    def setUp(self):
        try:
...
class TestAmenity_save(unittest.TestCase):
    """
    Unittests save method of Amenity class.
    """
...
class TestAmenity_to_dict(unittest.TestCase):
    """
    Unittests to_dict method of Amenity class.
    """
    def setUp(self):
        try:
            os.rename("file.json", "tmp.json")
