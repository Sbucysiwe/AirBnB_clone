...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests testing prompting of HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests testing help messages of HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests testing exiting from HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests testing create from HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests testing show from HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests testing destroy from HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests testing all of HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests testing update from HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests testing count method of HBNB comand interpreter."""
